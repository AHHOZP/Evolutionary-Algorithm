...
class Cube():
    ...
    def apply_vector(self,m):
        ...
        # dampending
        self.vertex[m].v = np.add(self.vertex[m].v * 0.999, np.multiply(self.vertex[m].a, dt))
...
def create_bouncing_cube():
    a,b,c = 0,0,1
    cube_vertex = [Mass(0.15, [a+0, b+0, c+0]),
                Mass(0.1, [a+0, b+0, c+0.11547]),
                Mass(0.1, [a+0.11547, b+0, c-0.05773]),
                Mass(0.1, [a-0.05773, b-0.05, c-0.05773]),
                Mass(0.1, [a-0.05773, b+0.05, c-0.05773])]
...
ax.set_ylim3d([-0.20, 0.20])
ax.set_ylabel('Y')

ax.set_zlim3d([0, 0.4])
ax.set_zlabel('Z')

ax.set_title('Bouncing Test')

time_template = 'time = %.2fs'
time_text = ax.text(0, 0, 1.0, '')
time_text.set_text('')
...
# bouncing cube spin
'''cube.vertex[0].v = np.array([1,-1, 1])
cube.vertex[1].v = np.array([1,-1, 1])
cube.vertex[2].v = np.array([-1,-1,0])
cube.vertex[3].v = np.array([1,1,0])
cube.vertex[4].v = np.array([-1,1,0])
cube.vertex[5].v = np.array([1,1,0])
cube.vertex[6].v = np.array([-1,-1,0])
cube.vertex[7].v = np.array([-1,1,0])'''
